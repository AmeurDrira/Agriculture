...
void Encrypt_Payload(unsigned char *Data, unsigned char Data_Length, unsigned int Frame_Counter, unsigned char Direction, unsigned char *deviceAddress)
{
  ...
  for (i = 1; i <= Number_of_Blocks; i++)
  {
    ...
    Block_A[5] = Direction;
    if (deviceAddress[1] == 0xFF && deviceAddress[2] == 0xFF && deviceAddress[3] == 0xFF) {
      Block_A[6] = deviceAddress[0];
      Block_A[7] = deviceAddress[1];
      Block_A[8] = deviceAddress[2];
      Block_A[9] = deviceAddress[3];
